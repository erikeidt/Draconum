...
namespace com.erikeidt.Draconum
{
	...
	partial class AbstractStatementNode
	{
		...
		/// </param>
		protected abstract void GenerateCode ( CodeGenContext context );

		public void GenerateCodeWithPrettyPrint ( CodeGenContext context )
		{
		...
		///				if ( condition ) break;
		///			would results in conditional branches that branch around unconditional branches,
		///				-instead of-
		...
		///			break, continue, goto, return, throw, (infinite loop..)
		...
		///		To err conservative, return true.
		/// </summary>
		/// <returns>
